          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              {{--<form id="quickForm">--}}
                ...
                @endif 
              {{--<form id="quickForm">--}}
                {!!Form::open(['action'=>'App\Http\Controllers\EntrepriseController@saveentreprise' , 'method'=>'POST'])!!}
                {{csrf_field()}}
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('name', '' ,['class'=>'form-control' ,'id'=>'exampleInputEmail1', 'placeholder'=>'Nom d\'Entreprise'])}}
                  </div>
                  <div class="form-group">
                    {{--<label for="exampleInputEmail1">Product name</label>
                    <input type="text" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="Enter product name">--}}
                    {{Form::label('', 'Description d\'Entreprise' ,['for'=>'exampleInputEmail1'])}}
                    {{Form::text('description', '' ,['class'=>'form-control' ,'id'=>'exampleInputEmail1', 'placeholder'=>'description d\'Entreprise'])}}
                  </div>
